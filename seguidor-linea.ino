int IN1 = 8;  //se declara la variable de la entrada 1 del l298n
...
int sen2 = 3; //se declara el tope de carrera 2
int sen2sta = LOW; //se declara el estado del tope de carrera 2
...
void abajo(){  //funcion para descender 
  digitalWrite(IN1, HIGH);
  digitalWrite(IN2, LOW);
}

void sube (){  //funcion para ascender 
  digitalWrite(IN1, LOW);
...
void loop(){
  ...
  sen2sta = digitalRead(sen2); // estado del tope 1 es igual a la lectura del tope 2
